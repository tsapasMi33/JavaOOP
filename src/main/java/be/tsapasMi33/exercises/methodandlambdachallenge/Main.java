package be.tsapasMi33.exercises.methodandlambdachallenge;

import be.tsapasMi33.exercises.genericschallenge.Layer;
...
//                s -> new String("Howdy " + s),
    ...
    private static char getRandomChar(char startChar, char endChar) {
        return (char) r.nextInt((int) startChar, (int) endChar + 1);
    }
